...
export const useTimelineStore = create<TimelineStore>((set) => ({
  ...
  streamMetrics: {
      ...
      pipelines: { label: 'Oil & Gas Pipelines', source: 'Overture Maps', type: 'DuckDB viewport cache', count: 0, speed: '-', status: 'connecting', poll: 'on viewport', upstream: 'release cache' },
